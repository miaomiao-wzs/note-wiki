...
## 2026-08-20 | 新增概念页 | FICO
- 主题：负过账概念
- 来源：用户实际操作经验
- 改动：
  - 新增 [[wiki/fico/concepts/负过账]]：负过账计算规则（借方+负过账=贷方负数，贷方+负过账=借方负数）
  - 更新 [[wiki/fico/entities/FAGLB03]]：补充负过账查看说明
- 结论：负过账在同一借贷方向使用负数金额，可通过 FAGLB03 查看对借方/贷方总金额的影响
